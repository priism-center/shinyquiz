...
Note that the presence of a random question in a quiz will automatically set the quiz option of `sandbox = TRUE`. This removes the progress bar along the top and changes the behavior...
