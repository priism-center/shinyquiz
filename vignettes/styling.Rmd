  ...
  <div id="quiz-UI_quiz" class="shiny-html-output">
    ...
    <div>
      ...
      <div class="quiz-prompt">
        <div>...the contents of the quiz prmopt...</div>
      </div>
    </div>
...
Let's start with some basic styling to enhance the visual appeal of our quiz. We'll add some background colors, padding, and fonts.
