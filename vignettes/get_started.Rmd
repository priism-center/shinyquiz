...
```{r}
q3 <- create_question(
  'Which cities are captial cities?',
  add_choice('Paris', correct = TRUE),
...
- `sandbox`: lorem ipsum  
- `end_on_first_wrong`: lorem ipsum  
- `progress_bar`: lorem ipsum  
- `progress_bar_color`: lorem ipsum  
...
The `quiz_server()` outputs a reactive summary of the quiz that can be consumed by your Shiny application. 
