...
The `preview_app()` launches the quiz in a Shiny instance to quickly check the quiz design. You can also print the quiz to preview it without a Shiny runtime.
...
That's the basic idea! With the `shinyQuiz` package, you can easily create interactive quizzes and add them to your Shiny applications. If you want to share your app with others, be sure to check out the [Deploying to shinyapps.io article](get_started.html). Enjoy quiz making! 
