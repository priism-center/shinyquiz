...
Take caution when defining the `grader` function as some elements may return back an object of a different class that you are expected. It's recommended to always test the quiz.
